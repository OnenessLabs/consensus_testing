...
// checkpoint creates a MyClique checkpoint signer section from the provided list
...
// sign calculates a MyClique digital signature for the given block and embeds it
...
// the account may or may not have cast a MyClique vote.
...
// Tests that MyClique signer voting is evaluated correctly for various simple and
